...
with_node \
  ...
  --target "/Users/work/Desktop/photobrain/apps/mobile/ios/Pods/Target Support Files/Pods-PhotoBrain/ExpoModulesProvider.swift" \
   \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-constants" "expo-file-system" "expo-font" "expo-image" "expo-keep-awake" "expo-router"
